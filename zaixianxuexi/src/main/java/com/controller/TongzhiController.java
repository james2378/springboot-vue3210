    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(tongzhi !=null){
            ...
            BeanUtils.copyProperties( tongzhi , view );//把实体数据重构到view中
                ...
                //级联表
                JiaoshiEntity jiaoshi = jiaoshiService.selectById(tongzhi.getJiaoshiId());
                if(jiaoshi != null){
    ...
    */
    ...
    public R save(@RequestBody TongzhiEntity tongzhi, HttpServletRequest request){
        ...
        if(false)
            ...
            tongzhi.setJiaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<TongzhiEntity> queryWrapper = new EntityWrapper<TongzhiEntity>()
            .eq("jiaoshi_id", tongzhi.getJiaoshiId())
...
//                            tongzhiEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
