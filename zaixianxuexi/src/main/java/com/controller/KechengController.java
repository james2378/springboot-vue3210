...
//                            kechengEntity.setKechengName(data.get(0));                    //教案名称 要改的
//                            kechengEntity.setKechengPhoto("");//详情和图片
//                            kechengEntity.setKechengFile(data.get(0));                    //教案 要改的
//                            kechengEntity.setKechengTypes(Integer.valueOf(data.get(0)));   //教案类型 要改的
