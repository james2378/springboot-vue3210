    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教案名称" prop="kechengName">
                       <el-input v-model="ruleForm.kechengName"
                                 placeholder="教案名称" clearable  :readonly="ro.kechengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="教案名称" prop="kechengName">
                           <el-input v-model="ruleForm.kechengName"
                                     placeholder="教案名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="教案照片" prop="kechengPhoto">
                        <file-upload
                            tip="点击上传教案照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengPhoto" label="教案照片" prop="kechengPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="教案" prop="kechengFile">
                        <file-upload
                                tip="点击上传教案"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="教案" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.kechengFile"  >教案下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="教案类型" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择教案类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教案类型" prop="kechengValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="教案介绍" prop="kechengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengContent" label="教案介绍" prop="kechengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengPhoto: [
                              { required: true, message: '教案照片不能为空', trigger: 'blur' },
                          ],
                   kechengFile: [
                              { required: true, message: '教案不能为空', trigger: 'blur' },
                          ],
                   kechengTypes: [
                              { required: true, message: '教案类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   kechengContent: [
                              { required: true, message: '教案介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
